...
// 4. LOAD & RENDER (Displays Likes/Hugs)
...
function renderMemoryMarker(mem) {
    ...
    const glowIcon = L.divIcon({ className: 'custom-icon', html: `<div class="light-icon ${color}"></div>`, iconSize: [12, 12] });
    
    // Displays all reaction counts in the popup
    const popupHTML = `
        <div style="color:#222; text-align:center; min-width:150px;">
            <p><b>"${mem.message}"</b></p>
            <div style="display:flex; justify-content:space-around; border-top:1px solid #eee; padding-top:8px;">
